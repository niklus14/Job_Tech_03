...
const navItems: { id: Section; label: string; icon: React.ElementType }[] = [
  ...
  { id: "profile", label: "CV & Profil", icon: User },
  { id: "jobs", label: "İş Uyğunluğu", icon: Briefcase },
  { id: "skills", label: "Skill Analizi", icon: Target },
  { id: "career", label: "Karyera Yolu", icon: Map },
  { id: "salary", label: "Maaş Proqnozu", icon: DollarSign },
  { id: "market", label: "Bazar Pulsu", icon: TrendingUp },
  { id: "interview", label: "Müsahibə Koçu", icon: MessageSquare },
